...
public class BlackChunkGenerator  extends NoiseChunkGenerator<BlackGenSettings> {
    ...
    public BlackChunkGenerator(IWorld worldIn, BlackDimensionProvider provider, BlackGenSettings settingsIn) {
