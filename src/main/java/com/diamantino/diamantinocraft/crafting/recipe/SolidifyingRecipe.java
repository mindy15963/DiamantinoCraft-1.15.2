...
import com.diamantino.diamantinocraft.api.crafting.recipe.fluid.FluidIngredient;
import com.diamantino.diamantinocraft.api.crafting.recipe.fluid.IFluidInventory;
import com.diamantino.diamantinocraft.api.crafting.recipe.fluid.IFluidRecipe;
...
public class SolidifyingRecipe implements IFluidRecipe<IFluidInventory> {
    public static final IRecipeType<SolidifyingRecipe> RECIPE_TYPE = IRecipeType.register(DiamantinoCraft.getId("solidifying").toString());
