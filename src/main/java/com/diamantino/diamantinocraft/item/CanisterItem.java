...
public class CanisterItem extends Item implements IFluidContainer {
    public CanisterItem() {
        super(new Properties().group(DiamantinoCraft.ITEM_GROUP).maxStackSize(64));
        addPropertyOverride(DiamantinoCraft.getId("fluid_level"), (stack, world, entity) -> getFluid(stack).getAmount());
    }
