...
import com.diamantino.diamantinocraft.capability.EnergyStorageItemImpl;
...
public class EnergyStoringItem extends Item {
    ...
    public EnergyStoringItem(Properties properties, int maxEnergy, int maxReceive, int maxExtract) {
        ...
        addPropertyOverride(DiamantinoCraft.getId("charge"), (stack, world, entity) -> getChargeRatio(stack));
    }
